...
@configure(
    label='To email [MISP]',
    description='Returns email-src attribute belonging to an event"',
    uuids=[ 'misp.v2.event2email' ],
...
def dotransform(request, response):
    ...
    complete_url = "%s/attributes/returnAttributes/%s/%s/email-src" % (url, apikey, request.value)
