...
@configure(
    label='To IP [MISP]',
    description='Returns am IP address attributes belonging to an event"',
    uuids=[ 'misp.v2.event2ip' ],
...
def dotransform(request, response):
    ...
    complete_url = "%s/attributes/returnAttributes/%s/%s/ip-src&&ip-dst" % (url, apikey, request.value)
