...
"""
@configure(
    label='To domain [MISP]',
    description='Returns a domain and hostname attributes belonging to an event"',
    uuids=[ 'misp.v2.event2domain' ],
...
def dotransform(request, response):
    ...
    complete_url = "%s/attributes/returnAttributes/%s/%s/hostname&&domain" % (url, apikey, request.value)
